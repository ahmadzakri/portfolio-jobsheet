...
// Replace null links after the real live folders and PDF files are added.
const jobsheetRecords = Object.fromEntries(["zakri", "redza"].map((player) => [
  ...
  Array.from({ length: TOTAL }, (_, index) => {
    ...
    return {
      ...
      description: "Project files and a PDF have not been added yet. Add their links here to enable the live preview and PDF viewer.",
      liveUrl: null,
      pdfUrl: null,
    };
  }),
      ...
      return `<article class="jobsheet ${done ? "is-done" : ""} ${isFlipped ? "is-flipped" : ""}">
        <div class="job-inner">
          <div class="job-face job-front">
            ...
            <button class="detail-toggle" data-details="${index}" aria-expanded="${isFlipped}">UPLOAD / LINK <span>&#8635;</span></button>
